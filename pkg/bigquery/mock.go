...
func (c *Mock) CreateJoinableViewsForUser(ctx context.Context, name string, datasources []JoinableViewDatasource, fnrColumns []string) (string, string, map[uuid.UUID]string, error) {
	return "", "", nil, nil
}

...
func (r *queryResolver) Story(ctx context.Context, id uuid.UUID) (*models.GraphStory, error) {
...
func (r *queryResolver) StoryView(ctx context.Context, id uuid.UUID) (models.GraphStoryView, error) {

...
func (r *productAreaResolver) Stories(ctx context.Context, obj *models.ProductArea) ([]*models.Story, error) {
	teamsInPA, err := r.teamsInPA(ctx, obj.ID)
	if err != nil {
		return nil, err
	}
...
// Stories is the resolver for the stories field.
func (r *teamResolver) Stories(ctx context.Context, obj *models.Team) ([]*models.Story, error) {

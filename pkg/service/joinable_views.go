...
func GetJoinableViewsToBeDeletedWithRefDatasource(ctx context.Context) ([]gensql.GetJoinableViewsToBeDeletedWithRefDatasourceRow, error) {
	return queries.GetJoinableViewsToBeDeletedWithRefDatasource(ctx)
}

func GetJoinableViewsWithReference(ctx context.Context) ([]gensql.GetJoinableViewsWithReferenceRow, error) {
	return queries.GetJoinableViewsWithReference(ctx)
}

func SetJoinableViewDeleted(ctx context.Context, id uuid.UUID) error {
	return queries.SetJoinableViewDeleted(ctx, id)
}

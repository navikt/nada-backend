...
UPDATE third_party_mappings SET dataset_id = (SELECT id FROM datasets WHERE dataproduct_id = dataproduct_id);
ALTER TABLE third_party_mappings
...
UPDATE dataset_access SET dataproduct_id = (SELECT id FROM datasets WHERE dataproduct_id = dataproduct_id);
ALTER TABLE dataset_access

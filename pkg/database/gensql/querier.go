...
type Querier interface {
	...
	GetDataproductMappings(ctx context.Context, datasetID uuid.UUID) (ThirdPartyMapping, error)
	...
	GetDataproductsByMapping(ctx context.Context, arg GetDataproductsByMappingParams) ([]Dataset, error)
